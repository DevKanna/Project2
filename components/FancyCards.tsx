        ...
        <View>
            ...
            <View style={[styles.card, styles.cardElevated]}>
                ...
                <View style={styles.cardBody}>
                    ...
                    <Text style={styles.cardLabel}>Save the nature</Text>
                    <Text style={styles.cardDescription}>Nature (also called the material world, the material universe, the natural world, and the natural universe) is all matter and energy in the universe. In scale, 'nature' includes everything from the subatomic to the universal.</Text>
